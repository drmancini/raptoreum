...
bistably under sustained load on the WAN swarm (F-75 for the per-signature figures at shallow versus
deep queue depth), with the cause **explicitly unproven** (F-76) and the two measurements that would
settle it. Includes a reproduction recipe.
